...
// cd ~/Dropbox/#BOITUVA/ADS/5ED/tarefa_1
// gcc ex1_oani.c -o ex1.exe -lm -Wall && ./ex1.exe
...
typedef struct {TNo *inicio, *final; int qtde; float soma;} TDescr; //coloquei descritos de soma aqui
...
{	int numero;
	//char nome[31]; 
	//float salario; 
	/*o nome e o salário já estão no TNo...então não precisa.. lá em cima vc declarou funcionario TNo*/
	TDescr lista;
	TNo *aux; //aqui vc pode tirar o ponteiro *ant, use o descritor final
